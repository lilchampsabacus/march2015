...
function renderCards(level){
  ...
  const speedLink=wrap.querySelector('a[href^="speed-check.html"]');if(speedLink)speedLink.href='speed-check.html?v=20260924-class-test';
  const speedReportLink=wrap.querySelector('a[href^="speed-check-progress.html"]');if(speedReportLink)speedReportLink.href='speed-check-progress.html?v=20260924-class-test';
  warmSpeedPage();
  return wrap;
}
